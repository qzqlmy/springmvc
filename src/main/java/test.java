...
public class test {
    ...
    public static void main(String[] args) {
        // 短信应用SDK AppID
        int appid = 1400224475; // 1400开头

        // 短信应用SDK AppKey

        String appkey = "02f38dc89eacc86e2536e31ec90b90d1";

        // 需要发送短信的手机号码
        String[] phoneNumbers = {"15297166648","15897169797"};

        // 短信模板ID，需要在短信应用中申请
        // NOTE: 这里的模板ID`7839`只是一个示例，
        // 真实的模板ID需要在短信控制台中申请
        int templateId = 359360;

        // 签名
        // NOTE: 这里的签名"腾讯云"只是一个示例，
        // 真实的签名需要在短信控制台中申请，另外
        // 签名参数使用的是`签名内容`，而不是`签名ID`
        String smsSign = "qzqdlmy";

        // 单发短信
        try {
            SmsSingleSender ssender = new SmsSingleSender(appid, appkey);
            SmsSingleSenderResult result = ssender.send(0, "86", phoneNumbers[0],
                    "【qzqdlmy】123456为您的登录验证码，请于2分钟内填写。如非本人操作，请忽略本短信。", "", "");
