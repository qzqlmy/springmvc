...
<html>
	...
	<body>
		...
		<header>
			...
			<a class="rt_searchIcon" href="map.jsp"><img style="width:70%;" src="img/mapIcon.png"></a>
		</header>
		...
		<div class="main">
			<div class="left-menu">
				<ul>
					<li class="active">最爱<span class="num-price"></span></li>
					<li>分类</li>
					<li>分类</li>
					<li>分类</li>
				</ul>
					...
					<ul>
						<li class="clearfix">
							...
							<div class="menu-txt">
								<h4>凉拌猪耳</h4>
								<h2>￥25.00</h2>
								<p class="list1">剩余<em>3</em>份，预计等待时间<em>5</em>分钟</p>
								<p class="list2">
									<div class="btn">
										<button class="minus">  
									 <strong>-</strong>  
