...
<html>
	...
	<body class="padd_40">	
								...
								<ul>
									...
									<li class="bor-bottom5-f1 bg-fff padb03">
										<div class="order-details-header">
											...
											<div class="fr toggleButton"><img src="img/xial_03.png"/></div>
											<div class="clearfix"></div>
										</div>
							...
							<div class="swiper-slide list-group">
								<ul>
									<li class="bor-bottom5-f1 bg-fff">
										...
										<div class="bg-fff pay-button-myorder">
											<button class="bg26c400" onclick="window.location.href='order-settlement.jsp';">重新下单</button>
										</div>
									</li>
							...
							<div class="swiper-slide list-group">
								<ul>
									<li class="bor-bottom5-f1 bg-fff">
										...
										<div class="bg-fff pay-button-myorder">
											<button class="bgf58d05" onclick="window.location.href='evaluate.jsp';">评价</button>
		...
		<nav>
			...
			<a href="my-order.jsp" class="categoryIcon addclasstruenav"><img src="img/index2-1.png">订单</a>
