    ...
    <form id="addForm" class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="foodname" name="goodsName" required lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <span class="layui-btn" id="submit">立即提交</span>
       ...
       var url=$("#hhff").val();
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                window.location.href="/Ordering/queryfoodlistq";
            }
